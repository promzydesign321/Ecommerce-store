...
const Navbar = () => {
  ...
  const activeLinkClass = ({ isActive }) =>
    isActive
      ...
      : "text-charcoal hover:text-gold transition-colors duration-300";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link to="/" className="flex flex-col leading-tight">
            <span className="font-serif text-2xl md:text-3xl font-semibold tracking-wider text-charcoal">
              XYZ
            </span>
            <span className="text-[10px] tracking-[0.3em] uppercase text-muted font-sans -mt-1">
              Collection
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              ...
              className="flex items-center gap-2 text-xs tracking-widest uppercase text-green-700 hover:text-green-600 transition-colors duration-300 font-medium"
            >
              {/* WhatsApp SVG icon */}
      ...
      {menuOpen && (
        <div className="md:hidden bg-cream border-t border-beige px-6 py-6 flex flex-col gap-5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm tracking-widest uppercase font-medium text-green-700"
          >
            📲 Order via WhatsApp
          </a>
        </div>
